...
import models.cmt_pyvit
import models.edgevit
import models.v2_shunted
import models.conv_pvt2mlp13
import models.v4_shunted
parser.add_argument('--model', default='v4_shunted_xxs', type=str)
