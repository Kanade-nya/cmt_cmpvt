...
from models.v2_shunted import v2_shunted
from models.conv_pvt2mlp12 import conv_pvt2mlp_tiny12
from models.conv_pvt2mlp13 import conv_pvt2mlp_tiny13
from models.cmt_pyvit import cmpvt
...
def get_args_parser():
    ...
    parser.add_argument('--data-path', default='/datasets01/imagenet_full_size/061417/', type=str,
                        help='dataset path')
    parser.add_argument('--data-set', default='IMNET', choices=['CIFAR', 'CIFAR10', 'IMNET', 'INAT', 'INAT19','FLOWERS','CHAOYANG'],
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # 训练一个epoch 没有具体看
        train_stats, train_time = train_one_epoch(
        ...
        # 训练后进行评估
        test_stats, eval_time = evaluate(data_loader_val, model, device)
        print(f"Accuracy of the network on the {len(dataset_val)} test images: {test_stats['acc1']:.1f}%")
